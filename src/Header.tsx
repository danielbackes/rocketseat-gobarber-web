...
const Header: React.FC = () => (
  <Helmet>
    ...
    <meta property="og:url" content="https://gobarber.danielbackes.dev/" />
    ...
    <meta
      property="og:image"
      content="https://gobarber.danielbackes.dev/logo.png"
    />

    <meta property="twitter:card" content="photo" />
    <meta property="twitter:url" content="https://gobarber.danielbackes.dev/" />
